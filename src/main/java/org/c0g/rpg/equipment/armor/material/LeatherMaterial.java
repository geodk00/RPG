...
public class LeatherMaterial implements ArmorStrategy{
    private static final int HP_BASE = 20;
    private static final int HP_LVL = 8;
    private static final int STR_BASE = 1;
    private static final int STR_LVL = 1;
    private static final int DEX_BASE = 3;
    private static final int DEX_LVL = 2;
